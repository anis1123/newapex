...
class FacultyController extends Controller
{
    ...
    public function faculty(){
        ...
        $facultyfulltime=faculty::wherePivotIn('post', ["Full Time Faculty","BBA-TT Program Head","BBA-BI Program Head","BBA Program Head","BCIS Program Head","MBA Evening Program Coordinator","Associate Director Graduate Program","Head-Apex Career Services","Associate Director Undergraduate Program","Head-Communication Department"])->paginate(7);
        $facultyvisiting=faculty::wherePivotIn('post', "Visiting Faculty")->paginate(7);
        $facultyadmin=faculty::wherePivotIn('post', ["Administration","Examination Department","MIS","Apex Career Service","Lab and Maintenance","Accounts","Finance and Administration","Server","Library"])->paginate(7);
        $facultymain=faculty::wherePivotIn('post', ["Principal","Vice Principal","Chairperson","Faculty Development Advisor","Director, Student Affairs","Director, Academic Affairs"])->paginate(7);
