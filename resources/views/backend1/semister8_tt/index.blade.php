...
<div class="dashboard-wrapper pt-5">
        <div class="container-fluid py-5">
                <div class="row justify-content-center py-5">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">BBA-TT<br><small>Display Semister VIII Plan</small></div>
                                <!-- <ol class="breadcrumb">
                                    <li>
                                ...
                                <div class="card-header">
                                    <div class="pull-left">
                                        <a href="{{ route('backend1.semister8_tt.create') }}" class="btn btn-primary">Add Plan</a>
                                    </div>
                                </div>
                                    <div class="card-body">
                                        @if(session('message'))
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    @foreach($trimister1post as $post)
                                                        <tr>
                                                            <td>
                                                               {!! Form::open(['method' => 'DELETE', 'route' => ['backend1.semister8_tt.destroy', $post->id]]) !!}
                                                                <a href="{{ route('backend1.semister8_tt.edit', $post->id) }}" class="btn btn-xs btn-default">
