...
<div class="dashboard-wrapper pt-5">
        <div class="container-fluid py-5">
                <div class="row justify-content-center py-5">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">BBA-TT<br><small>Display Concentration Title and Body</small></div>
                                <!-- <ol class="breadcrumb">
                                    <li>
                                ...
                                <div class="card-header">
                                    <div class="pull-left">
                                        <a href="{{ route('backend1.concentration_tt.create') }}" class="btn btn-primary">Add New </a>
                                    </div>
                                </div>
                                    <div class="card-body">
                                        @if(session('message'))
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    @foreach($concentrationpost as $post)
                                                        <tr>
                                                            <td>
                                                            {!! Form::open(['method' => 'DELETE', 'route' => ['backend1.concentration_tt.destroy', $post->id]]) !!}
                                                                <a href="{{ route('backend1.concentration_tt.edit', $post->id) }}" class="btn btn-xs btn-default">
