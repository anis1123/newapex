                            ...
                            <div class="card-body">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body ">
                                        ...
                                        <div class="row">
                                                <form  role="form" method="GET" action="{{route('updatemsg',['chairmanmsg'=>$chairmanmsg])}}" enctype="multipart/form-data">
                                                        @csrf
                                                        ...
                                                        <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                                                            ...
                                                            <div class="col-md-12">
                                                                <textarea type="text" class="form-control" cols="200" rows="1000" name="message_detail"  required autofocus>{{ $chairmanmsg->message_detail}}</textarea>
